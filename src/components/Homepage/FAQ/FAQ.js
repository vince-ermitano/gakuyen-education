        ...
        <section id="faq" className="page-section" data-aos="fade-up">
            ...
            <div className="faq-questions-container">
                <section className="faq-group">
                    ...
                    />
                    <FaqItem
                        question="How Will This Course Help Me Monetize My Creative Work?"
                    ...
                    />
                    <FaqItem
                        question="Is This Course Suitable for Beginners or Advanced Creatives?"
                        answer="Our course is designed to cater to a wide range of skill levels. While beginners can build a strong foundation, advanced creatives can refine their skills and learn new, cutting-edge techniques, especially in areas like AI integration and advanced post-production."
                    />
                    <FaqItem
                        question="What Unique Insights Does This Course Offer Compared to Other Online Courses?"
                ...
                <section className="faq-group">
                    <FaqItem
                        question="Can I Balance This Course with My Full-Time Job or Studies?"
                    ...
                    />
                    <FaqItem
                        question="What Support and Resources Are Available to Students During and After the Course?"
                    ...
                    />
                    <FaqItem
                        question="Are There Real-World Applications and Projects in the Course?"
                        answer="Yes, the course includes several real-world projects and applications. You'll work through a professional brief from start to finish, applying your learning in a practical setting that mimics real industry challenges."
                    />
                    <FaqItem
                        question="What Is the Return on Investment for Completing This Course?"
